...
export type { MockSCLO } from "./contracts/MockSCLO";
export { MockSCLO__factory } from "./factories/contracts/MockSCLO__factory";
export type { PayrollConsumer } from "./contracts/PayrollConsumer";
export { PayrollConsumer__factory } from "./factories/contracts/PayrollConsumer__factory";
